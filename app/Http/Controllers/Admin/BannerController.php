...
class BannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(auth()->user()->permissions()->where('name','=','add-'.$model)->first()!= null) {
            ...
            //$banner->arabic_title = $request->input('arabic_title');   
            $banner->description = $request->input('description');               
            //$banner->arabic_description = $request->input('arabic_description');               
            ...
            $banner['image'] = 'uploads/banner/'.$safeName;
            // New Code
    ...
    public function update(Request $request, $id)
    {
       ...
       // $requestData['arabic_title'] = $request->input('arabic_title');
        $requestData['description'] = $request->input('description');
        //$requestData['arabic_description'] = $request->input('arabic_description');
   ...
   //          Image::make($file)->save($pathToStore . DIRECTORY_SEPARATOR. $fileNameToStore);
            ...
            $safeName = $fileName.'_'.time().'.'.$fileExt;
            $file->move($destinationPath, $safeName);
            $requestData['image'] = 'uploads/banner/'.$safeName;
            // New Code   
