...
Route::get('/book-ambulance','HomeController@bookAmbulance')->name('book_ambulance');
Route::get('/covid-test','HomeController@covidTest')->name('covid_test');
Route::get('/patient-signup','HomeController@patientSignup')->name('patient_signup');
Route::get('/ticket','HomeController@ticket')->name('ticket');
Route::post('/book-ambulance-submit','HomeController@bookAmbulanceSubmit')->name('book_ambulance_submit');
Route::post('/patient-signup-submit','HomeController@patientSignupSubmit')->name('patient_signup_submit');
...
Route::resource('admin/book-ambulance', 'Admin\\BookAmbulanceController');
Route::resource('admin/patient-signup', 'Admin\\PatientSignupController');